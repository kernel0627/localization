...
这份说明连接几何模型、局部反演、误差传播、阈值、增益与通信成本。详细计算分别见[参考残差传播](../../docs/q2/参考残差传播与校准阈值.md)、[底角区间预算](../../docs/q2/底角区间与位置预算.md)、[几何边界](../../docs/q2/几何边界核验.md)、[测角误差与增益](../../docs/q2/测角误差与增益选择.md)和[调整协议对照](../../docs/q2/参考建立与调整协议对照.md)。
...
含噪时，参考校准首先需要测量不确定度预算，再选择有限时域增益。参考误差由全队共同继承，接收机自身噪声和收敛速度可以通过独立的 $\eta_R$ 调节。第 12 节的等增益结果与[分阶段增益分析](../../docs/q2/测角误差与增益选择.md)给出当前噪声与观测预算下的选择依据。固定预算末端精度、单次置信集合以及完整在线统计验收分别报告，不能用其中一个代替其余两项。
...
| 需要核对的结论 | 推导与实现 | 原始证据 |
|---|---|---|
| 两底角反演、十二机闭环 | [基础实现](../../scripts/q2/triangle_reference.py)、[运行说明](../../docs/q2/三角基准调整.md) | [26 例基础批次](../../outputs/q2/triangle_reference/summary.json) |
| 参考传播符号与有限校准 | [残差分析](../../docs/q2/参考残差传播与校准阈值.md) | [残差与阈值汇总](../../outputs/q2/reference_residual/summary.json) |
| 最坏方向、接收机偏差及同观测反例 | [几何边界](../../docs/q2/几何边界核验.md) | [几何汇总](../../outputs/q2/geometry_boundaries/summary.json) |
| 精确位置集合与有限次置信检查 | [底角区间预算](../../docs/q2/底角区间与位置预算.md) | [预算表](../../outputs/q2/calibration_budget/summary.json) |
| 含噪协方差和阶段增益 | [误差与增益](../../docs/q2/测角误差与增益选择.md) | [噪声轨迹与理论](../../outputs/q2/noise_gain/summary.json) |
| 统一精度的协议成本 | [协议对照](../../docs/q2/参考建立与调整协议对照.md) | [93 例汇总](../../outputs/q2/protocol_comparison/summary.json) |
